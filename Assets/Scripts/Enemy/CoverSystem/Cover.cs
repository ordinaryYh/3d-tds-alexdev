...
public class Cover : MonoBehaviour
{
    ...
    public List<CoverPoint> GetValidCoverPoints(Transform enemy)
    {
        ...
        {
            if (IsValidCoverPoint(coverPoint, enemy) == true)
    ...
    private bool IsValidCoverPoint(CoverPoint coverPoint, Transform enemy)
    {
        ...
        if (IsCoverCloseToPlayer(coverPoint) == true)
            return false;

        if (IsCoverBehindPlayer(coverPoint, enemy) == true)
            return false;

        if (IsCoverCloseToLastCover(coverPoint, enemy) == true)
            return false;
